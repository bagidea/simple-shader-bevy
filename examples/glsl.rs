...
fn main() {
    ...
    .add_plugins(Material2dPlugin::<GLSLMaterial>::default())
...
fn setup_system(
    ...
    mut materials: ResMut<Assets<GLSLMaterial>>,
    ...
    if let Ok(mut window) = primary_window.get_single_mut() {
        ...
        commands.spawn((
            ...
            MeshMaterial2d(materials.add(GLSLMaterial {
                i_time: 0.,
...
fn update_system(
    time: Res<Time>,
    //mut query: Query<(&MeshMaterial2d<GLSLMaterial>, &mut Transform)>,
    query: Query<&MeshMaterial2d<GLSLMaterial>>,
    mut materials: ResMut<Assets<GLSLMaterial>>,
